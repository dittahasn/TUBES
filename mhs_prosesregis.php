<?php 
		...
		if (mysqli_num_rows($query)==0) {
			$query_mhs_register = mysqli_query($conn,"INSERT INTO mhs_user (mhs_nik,mhs_nama_lengkap,mhs_role,mhs_foto) VALUES ('$mhs_nik','$mhs_nama_lengkap','user','$mhs_foto')");
			...
			?>
				<script> 
					...
					window.location.assign("mhs_register.php");
				</script>
			<?php
		}?>